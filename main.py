...
def main(currentattacks,spawnedpids):
    ...
    if tcounter == 0:
        print (colored("                              Token : No tokens available."+menublank+now+" ",menucolour))
    elif tcounter == 1:
        print (colored("                              Token : There is "+str(tcounter)+" token found "+menublank+" ",menucolour))
    else:
        print (colored("                              Token : There is "+str(tcounter)+" token avaible "+menublank+" ",menucolour))
    print (colored("                                                                                       ",menucolour))
